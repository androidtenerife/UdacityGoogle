...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView error_mensaje;
    // complete (6) Add a TextView variable for the error message display
    private ProgressBar progressBar;
    // completerr (16) Add a ProgressBar variable to show and hide the progress bar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        error_mensaje = (TextView) findViewById(R.id.error_Tview);
        // completorr (7) Find the TextView for the error message using findViewById
        progressBar = (ProgressBar) findViewById(R.id.progBarr);
    ...
    // completer (8) Create a method called showWeatherDataView that will hide the error message and show the weather data
    public void showWeatherDataView() {
        error_mensaje.setVisibility(View.INVISIBLE);
        loadWeatherData();
    }
    ...
    public void showErrorMessage() {
        ...
        error_mensaje.setVisibility(View.VISIBLE);
    }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (mWeatherTextView.getText() == null) {
                showErrorMessage();
            }
